                ...
                <div className="col">
                    <section>
                        ...
                        <ul className="nav flex-column">
                            <NavLink className="nav-link" to="/about"><li className="nav-item">О магазине</li></NavLink>
                            <NavLink className="nav-link" exact to="/catalog"><li className="nav-item">Каталог</li></NavLink>
                            <NavLink className="nav-link" to="/contacts"><li className="nav-item">Контакты</li></NavLink>
                        </ul>
                    </section>
                </div>
                <div className="col">
